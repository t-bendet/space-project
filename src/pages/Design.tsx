const Design = (): JSX.Element => {
  return (
    <div className="container">
      <h1 className="uppercase tal">Design system</h1>
      <section id="colors">
      ...
      <section id="typography" style={{ margin: "4rem 0" }}>
        ...
        <div className="flex">
          <div className="typography__first" style={{ flexBasis: "100%" }}>
            <div>
          ...
          <div className="typography__second" style={{ flexBasis: "100%" }}>
            <div>
              <p className="text-accent">
      ...
      <section id="interactive-elements">
        ...
        <div className="flex">
          ...
          <div className="indicators" style={{ marginBottom: "50vh" }}>
            {/* Tabs */}
            ...
            <div className="numbered-indicators flex">
              ...
              <button aria-selected="false">1</button>
              <button aria-selected="false">1</button>
            </div>
          </div>
        </div>
